...
import com.fuhu.middleware.PostOffice;
...
public class VolleyActionProxy implements ISchedulingActionProxy, Runnable{
    ...
    Response.Listener<JSONObject> listener = new Response.Listener<JSONObject>() {
        ...
        public void onResponse(JSONObject jsonObject) {
            ...
            if(obtainItems!=null){
                ...
                Log.i(TAG, "obtainItems=null" );
                mPostOffice.onCommandFailed(mContext, mPostOfficeProxy, mMediaItem, ErrorCodeList.NO_MAILITEM_DATA);
            }
        }
    };
    ...
    Response.ErrorListener errorListener = new Response.ErrorListener() {
        ...
        ErrorCodeList errorCodeHandler = ErrorCodeList.UNKNOWN_ERROR;

        if (volleyError instanceof TimeoutError || volleyError instanceof NoConnectionError) {
            Log.e(TAG, "Timeout");
            errorCodeHandler = ErrorCodeList.VOLLEY_TIMEOUT;
        } else if (volleyError instanceof AuthFailureError) {
            Log.e(TAG, "Auth Failure Error");
            errorCodeHandler = ErrorCodeList.VOLLEY_AUTH_FAILURE;
        } else if (volleyError instanceof ServerError) {
            Log.e(TAG, "Server Error");
            errorCodeHandler = ErrorCodeList.VOLLEY_SERVER_ERROR;
        } else if (volleyError instanceof NetworkError) {
            Log.e(TAG, "Network Error");
            errorCodeHandler = ErrorCodeList.VOLLEY_NETWORK_ERROR;
        } else if (volleyError instanceof ParseError) {
            Log.e(TAG, "Parse Error");
            errorCodeHandler = ErrorCodeList.VOLLEY_PARSE_ERROR;
        }
