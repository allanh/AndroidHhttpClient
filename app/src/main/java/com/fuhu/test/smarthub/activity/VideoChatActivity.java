...
import com.fuhu.test.smarthub.adapters.ChatAdapter;
...
//                        mCallStatus.setVisibility(View.GONE);
                        ...
                        VideoRendererGui.update(localRender, 72, 65, 25, 25, VideoRendererGui.ScalingType.SCALE_ASPECT_FILL, true);
                    }
...
//                    mCallStatus.setVisibility(View.VISIBLE);
    ...
    private void endCall() {
        startActivity(new Intent(VideoChatActivity.this, WebRtcActivity.class));
        finish();
    }
