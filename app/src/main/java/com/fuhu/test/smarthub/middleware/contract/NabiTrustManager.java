...
public class NabiTrustManager implements X509TrustManager {

    private static final String TAG = NabiTrustManager.class.getSimpleName();
    ...
    public NabiTrustManager(KeyStore localKeyStore) {
        try {
            TrustManagerFactory tmf = TrustManagerFactory
                    .getInstance(TrustManagerFactory.getDefaultAlgorithm());
