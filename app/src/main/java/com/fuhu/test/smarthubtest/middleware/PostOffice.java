package com.fuhu.test.smarthubtest.middleware;

import android.content.Context;

import com.fuhu.test.smarthubtest.middleware.componet.AMailItem;
import com.fuhu.test.smarthubtest.middleware.componet.HTTPHeader;
import com.fuhu.test.smarthubtest.middleware.componet.ICommand;
import com.fuhu.test.smarthubtest.middleware.componet.IMailItem;
import com.fuhu.test.smarthubtest.middleware.componet.IPostOfficeProxy;
import com.fuhu.test.smarthubtest.middleware.componet.ISchedulingActionProxy;
...
import com.fuhu.test.smarthubtest.middleware.contract.GSONUtil;
import com.fuhu.test.smarthubtest.middleware.contract.OkHTTPRequest;
import com.fuhu.test.smarthubtest.middleware.contract.SchedulingActionProxy;
...
public enum PostOffice implements ICommand {
    ReqSendToIFTTT(1,1) {
        ...
        public synchronized Object doAction(Context mContext, IMailItem queryItem, IPostOfficeProxy mPostOfficeProxy, Object... obj) {
            ...
            return new SchedulingActionProxy(mContext, this, queryItem, false, mPostOfficeProxy,
                    HTTPHeader.getDefaultHeader(),
                    OkHTTPRequest.HTTP_ACTION_POST,
