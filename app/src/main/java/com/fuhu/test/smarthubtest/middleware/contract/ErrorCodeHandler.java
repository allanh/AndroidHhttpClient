...
public enum ErrorCodeHandler{
    UNKNOWN_EXCEPTION("-2","UNKNOWN_EXCEPTION"),
    Default("-1","Default"),
    Success("0","success"),
    OK("1","OK"),
    ...
    public static String getCode(IMailItem MailItem){
        ...
        //String errorCode = "";
        if(MailItem != null){
            if(MailItem instanceof com.fuhu.test.smarthubtest.middleware.componet.MailItem){
                if(((com.fuhu.test.smarthubtest.middleware.componet.MailItem)MailItem).getStatus() != null){
                    errorCode = ((com.fuhu.test.smarthubtest.middleware.componet.MailItem)MailItem).getStatus();
                }else{
